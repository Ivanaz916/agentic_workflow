...
### Background & Context
- **Primary Reference**: Always read the [Project Plan](../../../shop_local/.github/prompts/plan-shopLocalArlington.prompt.md) before starting a new task.
...
- Use terminal and fetch only for build/run/test within this repo; do not perform git push or Pages verification directly here.
